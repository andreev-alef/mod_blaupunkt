...
/**
 * Strings for component 'alef', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_alef
...
$string['modulename'] = 'alef';
$string['modulename_help'] = 'My special modeule';
$string['modulename_link'] = 'mod/alef/view';
