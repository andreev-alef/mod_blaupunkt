 ...
 * @return bool
 */
function xmldb_mod_helloworld_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2020112700) {
        ...
        // Define field userid to be added to mod_helloworld_messages.
        $table = new xmldb_table('mod_helloworld_messages');
        $field = new xmldb_field('userid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '1', 'id');

        // Define key userid (foreign) to be added to mod_helloworld_messages.
